...
def test_long_silence_is_tightened_not_deleted_entirely():
    ...
    intervals = build_keep_intervals(candidate, words, max_silence=0.7, retained_silence=0.14, remove_fillers=False)
...
def test_remap_words_moves_later_words_onto_compact_timeline():
    ...
    intervals = build_keep_intervals(candidate, words, max_silence=0.7, retained_silence=0.1, remove_fillers=False)
